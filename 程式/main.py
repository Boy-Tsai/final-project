...
class PongGame:
    ...
    def test_ai(self, net, Maxfit):
        ...
        while run:
            ...
            Maxfit_float=round(Maxfit,2) #顯示到小數點第二位
            self.game._draw_fitness(Maxfit_float) #pygame繪製fitness數值
...
def eval_genomes(genomes, config):
    ...
    pygame.display.set_caption("Pong3")
...
def test_best_network(config):
    ...
    pong = PongGame(win, width, height)
    MaxFit=winner.fitness
    pong.test_ai(winner_net,MaxFit)
