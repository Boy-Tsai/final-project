...
class Game:
    ...
    small_SCORE_FONT = pygame.font.SysFont("comicsans", 25)
    WHITE = (255, 255, 255)
    BLACK = (0, 0, 0)
    RED = (255, 0, 0)
    ...
    def _draw_fitness(self,fitness):  #新增在pygame內繪製fitness數值的程式
        fitness_text = self.small_SCORE_FONT.render(
            f"fitness:{fitness}", 1, self.WHITE)
        self.window.blit(fitness_text, (500,0))
